...
config.General.requestName = 'SingleNeutrino200PU_PhaseIIFall17D'
...
#config.Data.outputPrimaryDataset = 'SingleNeutrino_PU200'
config.Data.splitting = 'FileBased'
config.Data.outLFNDirBase = '/store/user/jhkim/'
config.Data.publication = False
config.Data.outputDatasetTag = 'SingleNeutrino_200PU_PhaseIIFall17D'
