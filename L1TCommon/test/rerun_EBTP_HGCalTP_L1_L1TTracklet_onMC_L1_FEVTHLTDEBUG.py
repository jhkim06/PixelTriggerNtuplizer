...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/PhaseIIFall17D/SingleE_FlatPt-2to100/GEN-SIM-DIGI-RAW/L1TnoPU_93X_upgrade2023_realistic_v5-v1/80000/00544DCE-BE37-E811-B1EA-06C6240000BC.root'),
...
process.TFileService = cms.Service(
    'TFileService',
    fileName = cms.string('SingleEleNoPU_.root')
)
